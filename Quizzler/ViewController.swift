...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        totalQuestions = CGFloat(allQuestions.list.count)
    ...
    func updateUI() {
        ...
        progressBar.frame.size.width = (view.frame.size.width / totalQuestions) * CGFloat(questionNumber + 1)
    }
